  ...
  return (
    <div className="bg-background-dark font-display text-white transition-colors duration-200 min-h-screen pb-24">
      ...
      <div className="sticky top-0 z-20 bg-background-dark/95 backdrop-blur-md px-4 py-3 flex items-center justify-between border-b border-gray-800">
        <div className="flex items-center gap-3" onClick={() => onNavigate(ScreenName.ACCOUNT)}>
          ...
          <div className="flex flex-col cursor-pointer">
            <p className="text-xs text-gray-400 font-normal">Welcome back,</p>
        ...
        <div className="relative overflow-hidden rounded-xl shadow-lg bg-surface-dark group cursor-pointer hover:shadow-xl transition-all">
          ...
          <div className="relative z-10 p-5 flex justify-between items-center">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-gray-300 font-medium">Sunny Intervals</p>
              <p className="text-xs text-gray-400 mt-2">Rain expected at 15:00</p>
            </div>
      ...
      <div className="flex items-center justify-between px-4 pt-6 pb-2">
        <h3 className="text-white text-lg font-bold tracking-tight">My Land Status</h3>
        <button onClick={() => onNavigate(ScreenName.MY_FARM)} className="text-primary text-sm font-semibold hover:underline">View All</button>
      </div>
      ...
      <div className="flex overflow-x-auto pb-4 px-4 gap-4 scrollbar-hide snap-x snap-mandatory no-scrollbar">
        ...
        <div onClick={() => onNavigate(ScreenName.LAND_DETAIL)} className="snap-center shrink-0 w-[280px] bg-surface-dark rounded-xl p-3 shadow-sm border border-gray-800 cursor-pointer active:scale-[0.98] transition-transform">
          ...
          <div className="flex justify-between items-start mb-2">
            <div>
              <h4 className="text-white font-bold text-base">Paddy Field A</h4>
              <p className="text-gray-400 text-xs">Rice Variant IR64</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2 mt-2">
            ...
            <div className="bg-background-dark/50 p-2 rounded-lg">
              <p className="text-[10px] text-gray-500 uppercase font-bold">pH Level</p>
              <div className="flex items-center gap-1">
        ...
        <div onClick={() => onNavigate(ScreenName.LAND_DETAIL)} className="snap-center shrink-0 w-[280px] bg-surface-dark rounded-xl p-3 shadow-sm border border-gray-800 cursor-pointer active:scale-[0.98] transition-transform">
          <div className="relative w-full aspect-video rounded-lg overflow-hidden mb-3">
            ...
            <div className="absolute top-2 right-2 bg-yellow-500/90 text-black text-xs font-bold px-2 py-1 rounded">Needs Water</div>
          </div>
          <div className="flex justify-between items-start mb-2">
            <div>
              <h4 className="text-white font-bold text-base">Chili Plot B</h4>
              <p className="text-gray-400 text-xs">Red Curly Chili</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2 mt-2">
            <div className="bg-red-900/20 p-2 rounded-lg border border-red-900/30">
              <p className="text-[10px] text-red-400 uppercase font-bold">Moisture</p>
              <div className="flex items-center gap-1">
      ...
      <h3 className="text-white text-lg font-bold tracking-tight px-4 pt-4 pb-2">Action Required</h3>
      <div className="flex flex-col gap-3 px-4">
        ...
        <div className="flex items-start gap-3 p-4 rounded-xl bg-red-900/10 border-l-4 border-red-500 shadow-sm">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-bold text-white">Pest Detected</h4>
            <p className="text-xs text-gray-300 mt-1 mb-3">Fall Armyworm detected near Plot B. Immediate action recommended.</p>
            <button onClick={() => onNavigate(ScreenName.PEST_DETAIL)} className="bg-red-600 hover:bg-red-700 text-white text-xs font-bold py-2 px-4 rounded-lg w-full sm:w-auto transition-colors">View Details</button>
          </div>
        </div>
        {/* Task Alert */}
        <div className="flex items-start gap-3 p-4 rounded-xl bg-surface-dark border border-gray-800 shadow-sm">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
              <h4 className="text-sm font-bold text-white">Fertilization Schedule</h4>
              <span className="text-[10px] bg-gray-700 text-gray-300 px-2 py-0.5 rounded">Tomorrow</span>
            </div>
            <p className="text-xs text-gray-300 mt-1 mb-3">Schedule NPK fertilization for Paddy Field A to optimize growth.</p>
            <button onClick={() => onNavigate(ScreenName.TASK_DETAIL)} className="bg-primary hover:bg-green-400 text-black text-xs font-bold py-2 px-4 rounded-lg w-full sm:w-auto transition-colors">Mark Complete</button>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between px-4 pt-6 pb-2 cursor-pointer" onClick={() => onNavigate(ScreenName.MARKETPLACE)}>
        <h3 className="text-white text-lg font-bold tracking-tight">Market Prices</h3>
        <span className="text-xs text-gray-500 hover:text-primary transition-colors">Updated 10m ago</span>
      </div>
      <div className="flex overflow-x-auto pb-4 px-4 gap-3 scrollbar-hide no-scrollbar">
        {[
          { name: 'Rice / kg', price: 'Rp 12,000', change: '+2.5%', trend: 'up', color: 'green' },
          { name: 'Chili / kg', price: 'Rp 45,000', change: '-5.1%', trend: 'down', color: 'red' },
          { name: 'Corn / kg', price: 'Rp 8,500', change: '0.0%', trend: 'flat', color: 'gray' }
        ].map((item, idx) => (
      ...
      {/* Latest Insights */}
      <h3 className="text-white text-lg font-bold tracking-tight px-4 pt-2 pb-3">Latest Insights</h3>
      <div className="px-4 pb-6 flex flex-col gap-4">
        <div onClick={() => onNavigate(ScreenName.EDUCATION)} className="flex gap-3 bg-surface-dark rounded-lg p-3 shadow-sm border border-gray-800 cursor-pointer hover:bg-surface-highlight transition-colors">
          ...
          <div className="flex flex-col justify-between">
            <div>
              <span className="text-[10px] font-bold text-primary uppercase tracking-wide">Government</span>
              <h4 className="text-sm font-bold text-white leading-snug line-clamp-2">New subsidized fertilizer distribution starts next week</h4>
            </div>
